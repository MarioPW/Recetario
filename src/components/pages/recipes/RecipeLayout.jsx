    ...
    >
      ...
      <div className="flex flex-col mx-auto mt-6 p-6 w-full max-w-4xl h-full">
        ...
        <div className="flex justify-end mb-4 space-x-4">
          <SearchInput
            items={recipes}
            url="/Recetario/recipe"
            withDropdown={true}
          />

          <Button
            onClick={() => setSortBy('name')}
            className={`${sortBy === 'name' ? 'bg-blue-600' : 'bg-gray-400'
          ...
          <Button
            ...
            className={`${sortBy === 'category' ? 'bg-blue-600' : 'bg-gray-400'
              } hover:bg-blue-700 transition`}
          >
          ...
          <Table.Body>
            {sortedRecipes.map((receta) => (
              ...
              >
                ...
                <Table.Cell className="py-4 px-6"> <Link to='/Recetario/recipe' state={{ recipe: receta }} >{receta.category}</Link></Table.Cell>
              </Table.Row>
            ))}
          </Table.Body>
        </Table>
